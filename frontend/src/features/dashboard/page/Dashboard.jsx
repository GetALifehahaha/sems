	...
	return (
		<div className='p-6 flex flex-col'>
			...
			<div className='flex gap-2 bg-background border-4 border-white p-1 rounded-md w-fit'>
					<Button text="Daily" className={`font-semibold text-text/50 text-sm rounded-sm py-1 bg-background ${frequency === "daily" && 'bg-primary text-white'}`} onClick={() => handleFrequency('daily')}/>
					<Button text="Weekly" className={`font-semibold text-text/50 text-sm rounded-sm py-1 bg-background ${frequency === "weekly" && 'bg-primary text-white'}`} onClick={() => handleFrequency('weekly')}/>
					<Button text="Monthly" className={`font-semibold text-text/50 text-sm rounded-sm py-1 bg-background ${frequency === "monthly" && 'bg-primary text-white'}`} onClick={() => handleFrequency('monthly')}/>
			</div>
