...
const Dashboard = () => {
	...
	return (
		<div className='p-6 flex flex-col'>
			...
			{/* Frequency Toggle */}
			<div className='flex gap-2 bg-white p-1 rounded-xl w-fit shadow-lg'>
					<Button text="Daily" className={`font-semibold text-text/50 rounded-lg text-sm py-1 ${frequency === "daily" && 'bg-primary text-white'}`} onClick={() => handleFrequency('daily')}/>
					<Button text="Weekly" className={`font-semibold text-text/50 rounded-lg text-sm py-1 ${frequency === "weekly" && 'bg-primary text-white'}`} onClick={() => handleFrequency('weekly')}/>
					<Button text="Monthly" className={`font-semibold text-text/50 rounded-lg text-sm py-1 ${frequency === "monthly" && 'bg-primary text-white'}`} onClick={() => handleFrequency('monthly')}/>
			</div>
					...
					<div className="basis-1/3 flex flex-row gap-4">
						...
						<div className='flex flex-col flex-1 bg-white rounded-2xl shadow-2xl p-4 items-start'>
							...
							<div className="flex w-full justify-between items-center">
								...
								<BlockSubtitle className='font-semibold text-text/50 text-xs'>
